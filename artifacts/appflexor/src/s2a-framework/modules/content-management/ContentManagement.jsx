...
const AssestManager = lazy(() =>
    import("./assest-manager/AssestManager/AssestManager"),
);
const ContentPages = lazy(() =>
    import("./content-builder/ContentPages/ContentPages"),
);
const Post = lazy(() => import("./page-builder/Designer/components/Post/Post"));
...
const componentRegistry = {
    WEB_CONTENT: ContentPages,
    WEB_POSTS: Post,
    ASSET_MANAGER: AssestManager,
};
