...
import { moveChecker } from "../../form-builder/Designer/props-editors/utils";
import DndWrapper from "../../../../components/drag-and-drop-listing";

export default function BulkActionModal(props) {
    const {
        show,
        setShow,
        selectedItem,
    ...
    const appServiceKeysMapping = useMemo(() => {
        return {
            ...
            trigger: { operation: () => triggerPostRequest() },
        };
    }, []);
            ...
            <Modal
                ...
                <Modal.Header>
                    <Modal.Title
                        ...
                        <span>Configure Bulk Action</span>
                            ...
                            <>
                                ...
                                <Row className="mb-2">
                                    <Form.Group
                                        ...
                                        <Form.Control
                                            required
                                            type="text"
                                            placeholder="trigger service key"
                                            name="triggerServiceKey"
                                            value={action.triggerServiceKey}
                                            onChange={handleInput}
                                        />
                                    </Form.Group>
                                    <Form.Group
                                        ...
                                        as={Col}
                                        sm="6"
                                        controlId="valueExpression">
                                        <Form.Label>Service Params</Form.Label>
                                        <Form.Control
                                            type="text"
                                            defaultValue="[masterParams]"
                                ...
                                <Row className="mb-2">
                                    <Form.Group
                                        ...
                                        as={Col}
                                        sm="6"
                                        controlId="enableLookup">
                                        <Form.Label>Enable Lookup</Form.Label>
                                        <Form.Check // prettier-ignore
                                            name="enableLookup"
                                            value={action.enableLookup}
                                            checked={action.enableLookup}
                                            onChange={handleInput}
                                        />
                                    </Form.Group>
                                </Row>
                                {action.enableLookup && (
                                    <Row className="mb-2 lookup-options">
                                        <Form.Group
                                            className=""
                                            as={Col}
                                            sm="4"
                                            controlId="enableStatic">
                                        ...
                                        <Form.Group
                                            ...
                                            as={Col}
                                            sm="4"
                                            controlId="selectionType">
                                            <Form.Label htmlFor="SINGLE">
                                                Selection Type
                                            </Form.Label>
                                            <div className="d-flex flex-row gap-2">
                                                <Form.Check // prettier-ignore
                                        ...
                                        <Form.Group
                                            ...
                                            <div className="d-flex flex-row gap-2">
                                                <Form.Check // prettier-ignore
                                                    ...
                                                    onChange={handleInput}
                                                />
                                                <Form.Label htmlFor="MASTER_FIRST">
                                                    Master First
                                                </Form.Label>
                                                ...
                                                <Form.Check // prettier-ignore
                                                    ...
                                                    onChange={handleInput}
                                                />
                                                <Form.Label htmlFor="LOOKUP_FIRST">
                                                    Lookup First
                                                </Form.Label>
                                            </div>
                                        </Form.Group>
                                ...
                                {action.enableLookup &&
                                    action.enableStatic === "DYNAMIC" && (
                                        <Row>
                                            <Form.Group
                                                className=""
                                                as={Col}
                                                sm="6"
                                                controlId="serviceKey">
                                                <Form.Label>
                                                    Lookup Service Key
                                                </Form.Label>
                                                <Form.Control
...
function StaticOptions(props) {
    const { action, options, setOptions, handleLookupInput } = props;
                    ...
                    <>
                        <div className="col-sm-4 mb-3">
                            ...
                            <input
                                ...
                                onChange={e => handleLookupInput(e)}
                                value={action.mapLabel}
                            />
                        </div>
                        <div className="col-sm-4 mb-3">
