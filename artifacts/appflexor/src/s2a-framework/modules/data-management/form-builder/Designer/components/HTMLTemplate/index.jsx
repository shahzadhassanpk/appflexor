...
import HTMLTemplatePropsEditor from "../../props-editors/HTMLTemplatePropsEditor";
...
import { modeType } from "../../../Forms/FormViewer";
...
function HTMLTemplate(props) {
    ...
    useEffect(() => {
        ...
        if (
            props.component.data?.service_key &&
            modeType &&
            props.mode !== modeType.design
        ) {
            setData({});
            if (props.component.data?.filter_by !== "") {
                if (
                    props.formData?.id &&
                    props.formData?.id !== "" &&
                    ...
                    let _data = getData(
                        props.component.data.service_key,
                        props.formData[props.component.data.filter_by],
                    );
                }
            } else {
            ...
            {visible && (
                <>
                        ...
                        {props.mode &&
                            ...
                            data && (
                                <RenderHTML
                                    ...
                                    data={data}
                                    formData={props?.formData}></RenderHTML>
                            )}
                    ...
                    <ChildrenModal
                        ...
                        size="xl"
                        header="Edit Html">
                        <HTMLTemplatePropsEditor setShow={setShow} />
                    </ChildrenModal>
                </>
            )}
        </ErrorBoundary>
...
function RenderHTML({ componentData, htmlCollection, data, formData }) {
    ...
    function previewTemplate(html, data, formData) {
        ...
        const output = compiled({ data: data, formData: formData });
    ...
    return collapse && collapse !== "none" ? (
        ...
        <>
            {data && formData && (
                <Interweave
                    content={previewTemplate(htmlContent, data, formData)}
                />
            )}
        </>
    );
