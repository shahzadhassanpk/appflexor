...
export default function TextPropsEditor({ setShow }) {
    ...
    }, [context.selectedComponent, currentComponent]);
        ...
        <ErrorBoundary>
            <form>
                <div className="row">
                    ...
                    {context.selectedComponent.type !== "time" &&
                        context.selectedComponent.type !== "signature" && (
                            <div className="col-sm-12 mb-3">
                                <label className="px-1 form-check-label pointer">
                                    ...
                                    <input
                                        ...
                                        checked={
                                            inputField.isExpression === "YES"
                                                ? true
                                                : false
                                        }
                                    />
                                    <span className="ms-2"> is expression</span>
                                </label>
                                <textarea
                                    type="text"
                                    name="value"
                ...
                {/* {context.selectedComponent.type} */}
                {context.selectedComponent.type === "date" && (
                    <div className="row">
                        <div className="col-sm-4 mb-3">
                ...
                <div className="row">
                    {context.selectedComponent.type !== "date" &&
                        context.selectedComponent.type !== "time" &&
                        context.selectedComponent.type !== "datetime" &&
                        context.selectedComponent.type !== "signature" && (
                            <>
                                <div className="col-sm-4 mb-3">
                                    <label className="form-label">
                ...
                <div className="row">
                    {context.selectedComponent.type !== "date" &&
                        context.selectedComponent.type !== "time" &&
                        context.selectedComponent.type !== "checkbox" &&
                        context.selectedComponent.type !== "checklist" &&
                        context.selectedComponent.type !== "datetime" &&
                        context.selectedComponent.type !== "signature" && (
                            <>
                                <div className="col mb-3">
                                    <label className="form-label">
                                        Data Validation Expression (Regex)
                                    </label>
                                    <textarea
                                        type="text"
                                        name="regex"
