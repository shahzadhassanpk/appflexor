...
import AutoIncrementPropsEditor from "../../props-editors/AutoIncrementPropsEditor";
    ...
    return (
        <ErrorBoundary render={() => Error}>
            ...
            <Modal
                ...
                <Modal.Body>
                    <AutoIncrementPropsEditor setShow={setShow} />
                </Modal.Body>
            </Modal>
        </ErrorBoundary>
    );
