...
export default function ProcessWorkspaceList({ title, description, stats, items, loading = false, onRefresh, searchTerm, setSearchTerm, searchPlaceholder, columns, page, setPage, pageSize, setPageSize, onAdd, addLabel, renderActions }) {
