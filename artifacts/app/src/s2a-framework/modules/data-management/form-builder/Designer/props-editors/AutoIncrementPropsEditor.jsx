...
export default function AutoIncrementPropsEditor({ setShow }) {
    ...
    //     const userInput = props?.formData[data?.db_column];
    //     numberFormat(data?.format, userInput);
    // }, [props?.formData]);
                ...
                <div className="row mb-3">
                    ...
                    {/* <div className="col-sm-3">
                        ...
                        <input
                            ...
                            name="format"
                            className={`form-control form-control-sm ${
                                invalidFields["format"] !== undefined
                                    ? "form-control-danger"
                                    : ""
                            }`}
                            onChange={e => handleInputField(e)}
                            value={inputField.format}
                        />
                    </div> */}
