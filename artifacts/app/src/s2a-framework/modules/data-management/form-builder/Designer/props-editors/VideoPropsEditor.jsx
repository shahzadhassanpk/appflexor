...
export default function VideoPropsEditor({ setShow }) {
    ...
    useEffect(() => {
        if (context.selectedComponent && !isEmpty(context.selectedComponent)) {
            ...
            componentData.id = context.selectedComponent.id;
    ...
    return (
        <ErrorBoundary>
            <form className="s2a-video-prop-editor">
                <div className="row">
                ...
                <div className="row">
                    ...
                    <div className="col-sm-4">
                        ...
                        <ReactSelect
                            options={positions}
                            selectedOption={positions.find(
                                item => item.value === inputField.position,
                            )}
                ...
                <div className="row">
                    <div className="ms-2">
                        <DynamicCheckBoxs
                            ...
                            selectedItem={inputField["show_pagination"]}
                            handleChange={item =>
                                setInputField(prev => ({
                                    ...prev,
                                    show_pagination: item,
                                }))
                            }
                        />
                    </div>
                ...
                <p>
                    <span className="fw-bold">
                        Following extension are supported:
                    </span>
                    <br></br>
                    <span className="me-2">.mp4,</span>
                    <span className="me-2">.ogg,</span>
                    <span className="me-2">.webm,</span>
                    <br></br>
                    <span className="fw-bold">Width should be in:</span>
                    <br></br>
                    <span className="me-2">px,</span>
                    <span className="me-2">%,</span>
                    <span className="me-2">vw</span>
                </p>
            </form>
        </ErrorBoundary>
    );
