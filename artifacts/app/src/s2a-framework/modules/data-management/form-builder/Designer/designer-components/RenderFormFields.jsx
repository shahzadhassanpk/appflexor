...
export function RenderFormFields({
    ...
    function toggleShowHide(inputField = {}, field = {}) {
        let bool = true;

        if (field.hasOwnProperty("showHide")) {
            let togglerValueStr = field["showHide"];
            let togglerValueArr = togglerValueStr.split(".");
            let togglerValueKey = togglerValueArr[0] ? togglerValueArr[0] : "";
            let togglerValueCondition = togglerValueArr[1]
                ? togglerValueArr[1].toLowerCase() === "false"
                    ? "NO"
                    : "YES"
                : "NO";

            if (inputField[togglerValueKey] === "") {
                if (togglerValueCondition === "YES") return false;
                else return true;
            }

            if (inputField[togglerValueKey] === togglerValueCondition) {
                bool = true;
            } else {
                bool = false;
            }
                ...
                fieldsArr.map(field => {
                    return (
                        <React.Fragment key={field.id}>
                            {field.hidden ? null : (
                                <>
                                    {toggleShowHide(inputField, field) ? (
                                        <div className="mb-1">
